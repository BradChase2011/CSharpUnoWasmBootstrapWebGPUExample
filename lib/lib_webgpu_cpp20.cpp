...
void GetWGPU_RENDER_PIPELINE_DESCRIPTOR_DEFAULT_INITIALIZER(WGpuRenderPipelineDescriptor* source NOTNULL)
{
    *source = WGPU_RENDER_PIPELINE_DESCRIPTOR_DEFAULT_INITIALIZER;
}

void GetWGPU_CANVAS_CONFIGURATION_DEFAULT_INITIALIZER(WGpuCanvasConfiguration* source NOTNULL)
{
    *source = WGPU_CANVAS_CONFIGURATION_DEFAULT_INITIALIZER;
}

void GetWGPU_COLOR_TARGET_STATE_DEFAULT_INITIALIZER(WGpuColorTargetState* source NOTNULL)
{
    *source = WGPU_COLOR_TARGET_STATE_DEFAULT_INITIALIZER;
}

void GetWGPU_RENDER_PASS_COLOR_ATTACHMENT_DEFAULT_INITIALIZER(WGpuRenderPassColorAttachment* source NOTNULL)
{
    *source = WGPU_RENDER_PASS_COLOR_ATTACHMENT_DEFAULT_INITIALIZER;
}
